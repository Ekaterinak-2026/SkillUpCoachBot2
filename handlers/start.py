...
async def cmd_start(message: Message, state: FSMContext) -> None:
    ...
    welcome_text = (
        ...
        "Помогу тебе прокачать навыки — без перегруза и выгорания. "
        "Каждый день маленький шаг: теория, практика или общение. "
        "Я веду серию, считаю звёзды ⭐ и поддерживаю, когда мотивация уходит.\n\n"
        "🎯 Что я умею:\n"
        "• ☀️ Напоминать утром и 🌙 проверять вечером\n"
        "• 🔥 Вести серию успешных дней (streak)\n"
        "• ⭐ Считать звёзды за каждый шаг\n"
        "• 📊 Присылать дайджест с прогрессом раз в неделю\n"
        "• 🎯 Работать с несколькими навыками сразу\n\n"
        "📋 Как это работает:\n"
        "1️⃣ Ты выбираешь от 1 до 5 навыков\n"
        "2️⃣ Каждое утро я спрашиваю: какой шаг сделаешь?\n"
        "3️⃣ Вечером проверяю: получилось ли?\n"
        "4️⃣ Через месяц — видишь реальный прогресс\n\n"
...
async def process_goal_choice(callback: CallbackQuery, state: FSMContext) -> None:
    ...
    # Тексты сегментов — локально, чтобы обойти баг кэша texts.py
    goal_texts = {
        "start_it": (
            "🌱 Ты в начале пути.\n\n"
            "Это нормально — чувствовать, что вокруг слишком много всего, а ты не знаешь, за что схватиться. Я помогу не утонуть в этом.\n\n"
            "Мы выберем навыки и будем делать по одному маленькому шагу в день. Через месяц ты оглянешься и увидишь, что прошёл больше, чем ожидал.\n\n"
            "Поехали 🚀"
        ),
        "interview": (
            "🎯 У тебя есть цель и дедлайн.\n\n"
            "Это лучший мотиватор, который бывает. Я помогу не распыляться и каждый день делать шаг к офферу. Будем тренировать то, что спросят, и не забывать про отдых.\n\n"
            "Дальше — только вперёд 💪"
        ),
        "upgrade": (
            "📈 Ты уже работаешь, но чувствуешь, что застрял.\n\n"
            "Это знакомо многим. Я помогу выйти из рутины и системно расти. Один шаг в день — и через пару месяцев ты сам заметишь, как стал увереннее и глубже.\n\n"
            "Начнём 🔥"
        ),
        "expertise": (
            "🧠 Ты хочешь разобраться в теме по-настоящему.\n\n"
            "Это долгий путь, но он того стоит. Я буду рядом, чтобы ты не бросил на полпути. Каждый день — один шаг вглубь. Через месяц ты удивишься, сколько всего освоил.\n\n"
            "Погнали 💡"
        )
    }
    

    text = goal_texts.get(goal, goal_texts["start_it"])
    text += "\n\nДавай выберем первый навык:"
